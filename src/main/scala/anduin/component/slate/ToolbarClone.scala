...
final case class ToolbarClone(
  value: Value,
  onChange: Change => Callback,
  attachmentButton: TagMod
) {
  def apply(children: VdomNode*): ScalaComponent.Unmounted[_, _, _] = ToolbarClone.component(this)(children: _*)
}
...
object ToolbarClone {
  ...
  private case class Backend(scope: BackendScope[ToolbarClone, _]) {
    ...
    def render(props: ToolbarClone, children: PropsChildren): VdomElement = {
  ...
  private val component = ScalaComponent.builder[ToolbarClone](ComponentName)
    .stateless
