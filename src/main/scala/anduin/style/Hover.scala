...
private[style] final case class Hover(classes: List[String] = List.empty) {
  ...
  def backgroundPrimary5: Style = new Style(classes :+ "hover-bg-blue-5")
  def backgroundPrimary4: Style = new Style(classes :+ "hover-bg-blue-4")
  def backgroundPrimary3: Style = new Style(classes :+ "hover-bg-blue-3")
  def backgroundPrimary2: Style = new Style(classes :+ "hover-bg-blue-2")
  def backgroundPrimary1: Style = new Style(classes :+ "hover-bg-blue-1")

  def backgroundSuccess5: Style = new Style(classes :+ "hover-bg-green-5")
  def backgroundSuccess4: Style = new Style(classes :+ "hover-bg-green-4")
  def backgroundSuccess3: Style = new Style(classes :+ "hover-bg-green-3")
  def backgroundSuccess2: Style = new Style(classes :+ "hover-bg-green-2")
  def backgroundSuccess1: Style = new Style(classes :+ "hover-bg-green-1")

  def backgroundWarning5: Style = new Style(classes :+ "hover-bg-orange-5")
  def backgroundWarning4: Style = new Style(classes :+ "hover-bg-orange-4")
  def backgroundWarning3: Style = new Style(classes :+ "hover-bg-orange-3")
  def backgroundWarning2: Style = new Style(classes :+ "hover-bg-orange-2")
  def backgroundWarning1: Style = new Style(classes :+ "hover-bg-orange-1")

  def backgroundDanger5: Style = new Style(classes :+ "hover-bg-red-5")
  def backgroundDanger4: Style = new Style(classes :+ "hover-bg-red-4")
  def backgroundDanger3: Style = new Style(classes :+ "hover-bg-red-3")
  def backgroundDanger2: Style = new Style(classes :+ "hover-bg-red-2")
  def backgroundDanger1: Style = new Style(classes :+ "hover-bg-red-1")
