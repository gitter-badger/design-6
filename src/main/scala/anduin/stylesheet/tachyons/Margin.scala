...
private[tachyons] final case class Margin(classes: List[String] = List.empty) {
  ...
  def all3: Tachyons = new Tachyons(classes :+ "ma3")
  def all4: Tachyons = new Tachyons(classes :+ "ma4")
  def all5: Tachyons = new Tachyons(classes :+ "ma5")
  ...
  def left3: Tachyons = new Tachyons(classes :+ "ml3")
  def left4: Tachyons = new Tachyons(classes :+ "ml4")
  def left5: Tachyons = new Tachyons(classes :+ "ml5")
  ...
  def right3: Tachyons = new Tachyons(classes :+ "mr3")
  def right4: Tachyons = new Tachyons(classes :+ "mr4")
  def right5: Tachyons = new Tachyons(classes :+ "mr5")
  ...
  def bottom3: Tachyons = new Tachyons(classes :+ "mb3")
  def bottom4: Tachyons = new Tachyons(classes :+ "mb4")
  def bottom5: Tachyons = new Tachyons(classes :+ "mb5")
  ...
  def top3: Tachyons = new Tachyons(classes :+ "mt3")
  def top4: Tachyons = new Tachyons(classes :+ "mt4")
  def top5: Tachyons = new Tachyons(classes :+ "mt5")
  ...
  def vertical3: Tachyons = new Tachyons(classes :+ "mv3")
  def vertical4: Tachyons = new Tachyons(classes :+ "mv4")
  def vertical5: Tachyons = new Tachyons(classes :+ "mv5")
  ...
  def horizontal3: Tachyons = new Tachyons(classes :+ "mh3")
  def horizontal4: Tachyons = new Tachyons(classes :+ "mh4")
  def horizontal5: Tachyons = new Tachyons(classes :+ "mh5")
