...
private[tachyons] final case class Width(classes: List[String] = List.empty) {
  ...
  def w1: Tachyons = new Tachyons(classes :+ "w1")
  def w2: Tachyons = new Tachyons(classes :+ "w2")
  def w3: Tachyons = new Tachyons(classes :+ "w3")
  def w4: Tachyons = new Tachyons(classes :+ "w4")
  def w5: Tachyons = new Tachyons(classes :+ "w5")
  ...
  def percent33: Tachyons = new Tachyons(classes :+ "w-33")
  def percent34: Tachyons = new Tachyons(classes :+ "w-34")
