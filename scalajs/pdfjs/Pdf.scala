...
object PdfWorkerUrl {
  ...
  def pdfWorkerUrl(productionBuild: Boolean): String = if (productionBuild) {
...
object PDFJS extends js.Object {
  ...
  def getDocument(url: String | ArrayBuffer): PDFDocumentLoadingTask = js.native // linter:ignore UnusedParameter
  def getPage(number: Double): PDFPromise[PDFPageProxy] = js.native // linter:ignore UnusedParameter
  def renderTextLayer(renderParameters: TextLayerRenderParameters): TextLayerRenderTask = js.native // linter:ignore UnusedParameter
}
...
trait PDFDocumentLoadingTask extends js.Object {
  ...
  var onPassword: js.Function2[js.Function1[String, Unit], Int, _] = js.native // scalastyle:ignore var.field
...
trait PDFPageProxy extends js.Object {
  def getViewport(scale: Double, rotate: Double = ???): PDFPageViewport = js.native // linter:ignore UnusedParameter
  def render(params: PDFRenderParams): PDFRenderTask = js.native // linter:ignore UnusedParameter
  def getTextContent(params: getTextContentParameters): PDFPromise[TextContent] = js.native // linter:ignore UnusedParameter
  def cleanup(): Unit = js.native
  def getAnnotations(params: GetAnnotationsParameters): PDFPromise[js.Array[Annotation]] = js.native // linter:ignore UnusedParameter
}
...
object getTextContentParameters {
  def apply(normalizeWhitespace: Boolean = false): getTextContentParameters = {
    js.Dynamic.literal(normalizeWhitespace = normalizeWhitespace).asInstanceOf[getTextContentParameters]
  }
}
...
trait PDFPageViewport extends js.Object {
  ...
  def clone(params: ViewPortCloneParams): PDFPageViewport = js.native // linter:ignore UnusedParameter
}
...
object PDFRenderParams {
  def apply(canvasContext: CanvasRenderingContext2D, viewport: PDFPageViewport): PDFRenderParams = {
    js.Dynamic.literal(canvasContext = canvasContext, viewport = viewport).asInstanceOf[PDFRenderParams]
  }
...
trait LinkService extends js.Object {
  ...
  def onFileAttachmentAnnotation(options: FileAttachmentAnnotationOptions): Unit = js.native // linter:ignore UnusedParameter
  def cachePageRef(pageNum: Int, pageRef: js.Object): Unit = js.native // linter:ignore UnusedParameter
}
...
trait PDFAnnotationLayer extends js.Object {
  def render(parameters: AnnotationLayerParameters): Unit = js.native // linter:ignore UnusedParameter
  def update(parameters: AnnotationLayerParameters): Unit = js.native // linter:ignore UnusedParameter
}
