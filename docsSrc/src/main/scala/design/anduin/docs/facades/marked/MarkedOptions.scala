...
object MarkedOptions {
  /**
    ...
    * @param gfm Enable [[https://help.github.com/articles/github-flavored-markdown GitHub flavored markdown]].
    * @param tables Enable GFM [[https://github.com/adam-p/markdown-here/wiki/Markdown-Cheatsheet#wiki-tables tables]]. This option requires the gfm option to be true.
    * @param breaks Enable GFM [[https://help.github.com/articles/github-flavored-markdown#newlines line breaks]]. This option requires the gfm option to be true.
    * @param pedantic Conform to obscure parts of `markdown.pl` as much as possible. Don't fix any of the original markdown bugs or poor behavior.
